        ...
        <div class=" flex flex-col gap-5 w-full items-end ">
            ...
            <div class=" w-full">
                ...
                "extraMarkup": "<div class=\"absolute top-1/2 end-3 -translate-y-1/2\"><svg class=\"flex-shrink-0 size-3.5 text-gray-500 dark:text-neutral-500\" xmlns=\"http://www.w3.org/2000/svg\" width=\"24\" height=\"24\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"m7 15 5 5 5-5\"/><path d=\"m7 9 5-5 5 5\"/></svg></div>"
                    ...
                    ?>
                        <option value="<?= $genrow['id'] ?>"><?= $genrow['type'] ?></option>
                    <?php endwhile; ?>
                </select>
            </div>
            <div class=" w-full">
                <label for="date_of_birth" class="block text-sm font-medium mb-2 dark:text-white">Birth Date</label>
                <input type="date" name="date_of_birth" id="date_of_birth" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" placeholder="Pick Date">
            </div>
            <div class=" w-full">
                <label for="pocket_money" class="block text-sm font-medium mb-2 dark:text-white">Pocket Money</label>
                <input type="number" name="pocket_money" id="pocket_money" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" placeholder="Enter Pocket Money">
            </div>
