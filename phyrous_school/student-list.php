...
<section class=" bg-gray-50 overflow-scroll w-fit p-5 m-5 rounded-md ">
    ...
    <div class=" justify-end w-full flex gap-5">
        ...
        <a href="./student-create.php" type="button" name="calculate" class=" max-w-sm px-3 py-2 leading-loose text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none">
            Create Student
        </a>
    </div>
                    ...
                    <?php while ($row = mysqli_fetch_assoc($query)) : ?>
                        <tr>
                            ...
                            <td class="px-6 py-4 inline-block w-40 leading-10  whitespace-nowrap text-sm font-medium text-gray-800 dark:text-neutral-200 text-end">
                                <?= number_format($row['pocket_money']) ?>
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-neutral-200 text-end">
                                <div class="flex flex-col sm:inline-flex sm:flex-row rounded-lg shadow-sm">
                                    ...
                                    <a onclick="return confirm('are u sure u want to delete this row?')" href="./student-delete.php?row_id=<?= $row['student_id'] ?>" type="button" class="py-2 px-3 inline-flex justify-center items-center gap-2 -ms-px first:rounded-s-lg first:ms-0 last:rounded-e-lg text-sm font-medium focus:z-10 border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-white dark:hover:bg-neutral-800">
                                    ...
                                    <a href="./enroll-create.php?row_id=<?= $row['student_id'] ?>" type="button" class="py-2 px-3 inline-flex justify-center items-center gap-2 -ms-px first:rounded-s-lg first:ms-0 last:rounded-e-lg text-sm font-medium focus:z-10 border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-white dark:hover:bg-neutral-800">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4 stroke-blue-600">
