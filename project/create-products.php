    ...
    <form action="" enctype="multipart/form-data" method="post">
        <div class=" flex flex-col gap-5 mb-5">
            <div class="max-w-full">
                ...
                <input type="text" name="product_name" id="input-label" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" placeholder="Enter Product Name">
            </div>
            <div class="max-w-full">
                <label for="input-label" class="block text-sm font-medium mb-2 dark:text-white">Price</label>
                <input type="number" name="product_price" id="input-label" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" placeholder="Enter Product Price">
            </div>
            <div class="max-w-full">
                <label for="input-label" class="block text-sm font-medium mb-2 dark:text-white">Rating</label>
                ...
                }' name="product_rate" class="hidden">
                    <?php for ($i = 1; $i < 5; $i++) : ?>
