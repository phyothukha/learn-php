...
$from_curreny_name = $from_currency_arr[0];
...
<section class=" bg-gray-50 p-5 rounded-md mt-5">
    ...
    <!--  -->
    <p class=" text-3xl  text-center font-sans mb-5">
        <?= round($to, 2) ?> <?= $to_currency_name ?>
    </p>


    <div class="  flex gap-3">
        <a type="button" href="exchange.php" class="py-3 flex-grow justify-center  px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none">
            Calculate again
        </a>
        <a href="record.php" class="py-3 flex-grow justify-center px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-gray-100 text-gray-800 hover:bg-gray-200 disabled:opacity-50 disabled:pointer-events-none dark:bg-white/10 dark:hover:bg-white/20 dark:text-white dark:hover:text-white">
            Record List
        </a>
    </div>
</section>
